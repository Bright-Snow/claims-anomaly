...
The four filters and what each rules out: peer grouping (facility vs professional), minimum peer size, isolation (tight clusters), max_gap (split billing modes)
